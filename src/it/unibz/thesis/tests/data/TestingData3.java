...
public class TestingData3 {

	private static final PreferenceFile DATA = PreferenceFile.MOVIELENS_1000K;
	
	private static final int KNOWN = 20000;
	
	private static final int UNKNOWN = 20000;
	
	private static final int TEST = 300000;
	
	private static final int NUMBER_OF_TEST_SETS = 10;
	
	private static final String KNOWN_PATH = "data/known3-";
	
	private static final String UNKNOWN_PATH = "data/unknown3-";
	
	private static final String TEST_PATH = "data/test3-";
	...
	public static void main(String[] args) throws IOException {
		...
		List<Preference> prefs = testData(0);
