...
public class H08RatingsScoresInterval {
	...
	public static void main(String[] args) throws IOException {
		...
		MyLogger log = new MyLogger("score-log-"+dataset);
		
		MyLogger results = new MyLogger("score-res-"+dataset);
		...
		for (int i = 0; i < iterations; i++) {
			...
			List<Preference> group_best = tools.bestScoringPreferences(known, unknown, unknown_predicted, 1000);
